...
CREATE POLICY "All Authenticated user can do all Operation on Orders" ON "public"."orders" TO "authenticated" USING (true) WITH CHECK (true);
...
CREATE POLICY "Allow Authenticated users to do All operations" ON "public"."order_items" TO "authenticated" USING (true) WITH CHECK (true);
